        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2"><a href="{{ url('/featured-produtcs')}}" class="text-white">Featured Products</a></div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2">
                        <p>
                            <i class="fa fa-map-marker"></i> {{$appSetting->address ?? 'address name'}}
                        </p>
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        <a href="" class="text-white">
                            <i class="fa fa-envelope"></i> {{$appSetting->email2 ?? 'email1'}}
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="social-media">
                        ...
                        <a href="{{$appSetting->twitter}}" target="_blank"><i class="fa fa-twitter"></i></a> @endif
                        @if($appSetting->instagram)
                        <a href="{{$appSetting->instagram}}" target="_blank"><i class="fa fa-instagram"></i></a> @endif
                        @if($appSetting->youtube)
                        <a href="{{$appSetting->youtube}}" target="_blank"><i class="fa fa-youtube"></i></a> @endif
                    </div>
                </div>
            </div>
        </div>
