                ...
                <div class="col-md-12">
                    <div class="shadow bg-white p-3">
                                ...
                                <div class="d-md-flex align-items-start">
                                    ...
                                    <div class="tab-content col-md-9" id="v-pills-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="onlinePayment" role="tabpanel" aria-labelledby="onlinePayment-tab" tabindex="0">
                                            ...
                                            <hr />
                                            <button type="button" wire:loading.attr="disabled" wire:click="midtransPayment" class="btn btn-warning">Pay Now (Online Payment)</button>
                                        </div>
                                        <div>
                                            ...
                                            <div class="tab-pane fade" id="onlinePayment" role="tabpanel" aria-labelledby="onlinePayment-tab" tabindex="0">
                                                ...
                                                <button type="button" wire:loading.attr="disabled" wire:click="midtransPayment" class="btn btn-warning">Pay Now (Online Payment)</button>
                                                @if($snapTokenUrl)
                                                <p class="mt-2">SNAP Token URL: <a href="{{ $snapTokenUrl }}" target="_blank">{{ $snapTokenUrl }}</a></p>
                                                @endif
                                            </div>
                        ...
                        <div class="card card-body shadow text-center p-md-5">
                            ...
                            <a href="{{ url('collections')}}" class="btn btn-warning">Shop Now
                        </div>
                        @endif
                    </div>
