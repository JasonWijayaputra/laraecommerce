                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                <label class="badge btn-danger">NO ROLE</label>

                                @endif
                            </td>
                            <td>
                                <a href="{{ url('admin/users/'.$user->id.'/edit')}}" class="btn btn-sm btn-success">Edit</a>
                                <a href="{{ url('admin/users/'.$user->id.'/delete')}}" onlick="return confirm('Are you sure want to delete?')" class="btn btn-sm btn-danger">Delete</a>

                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="6a">No Users Available</td>
                        </tr>
                        @endforelse
