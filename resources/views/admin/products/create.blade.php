    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3>Add Products <a href="{{ url('admin/products')}}" class="btn btn-primary btn-sm text-white float-end">Back</a></h3>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{ url('admin/products')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <ul class=" nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="color-tab" data-bs-toggle="tab" data-bs-target="#color-tab-pane" type="button" role="tab" aria-controls="image-tab" aria-selected="false">Product Color</button>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="trending" value="0"> <!-- Hidden input for unchecked value -->
                                        <input type="checkbox" name="trending" value="1" style="width: 50px; height: 50px;" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class=" mb-3">
                                        <label>Status</label>
                                        <input type="hidden" name="status" value="0"> <!-- Hidden input for unchecked value -->
                                        <input type="checkbox" name="status" value="1" style="width: 50px; height: 50px;" />
                                    </div>
