...
<body>
    <div class="text-center">
        ...
        <p>Thank You for Purchasing With {{$appSetting->website_name ?? "Funda Of Web IT"}}</p>
        <br />
    ...
    <table>
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td colspan="4" class="fw-bold text-center total-heading">Total Amount - <small>Inc. All vat/tax</small></td>
                <td class="fw-bold total-heading">Rp.{{ $totalPrice }}</td>
            </tr>
        </tbody>
    </table>
